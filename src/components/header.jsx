  ...
  return (
    ...
    <div className="relative flex w-full items-center justify-between relative bg-primary pt-[36px] lg:px-[50px] xl:px-[200px] 2xl:px-[400px]">
      ...
      <div className="flex items-start gap-[17px] flex-[0_0_auto]">
        <a href="https://twitter.com/FabriXofficial"><img className="w-[18px] h-[18px]" alt="Twitter logo" src="images/twitter-logo.svg" /></a>
        <a href="https://twitter.com/FabriXofficial"><img className="w-[18px] h-[18px]" alt="Frame logo" src="images/instagram-logo.svg" /></a>
        {isConnected ? (address.slice(0,4) + "..." + address.slice(38)): "disconnected"}
      </div>
    </div>
    </>
  );
