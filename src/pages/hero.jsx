    ...
    return (
      <div className="relative flex flex-col items-center gap-[30px] mx-auto mt-[60px]">
        ...
        <div className="flex flex-col items-center gap-[10px]">
          ...
          <h2 className="max-w-[768px] [font-family:'Inter-Bold', Helvetica] font-bold text-[35px] sm:text-[50px] md:text-[70px] text-center traking-[0] leading-[65px]">
        ...
        <div className="max-w-100">
          <img className="w-[971px] z-[10]" alt="Characters" src="images/characters.png" />
        </div>        
      </div>
    );
}
